...
-- Run once in the Supabase SQL editor for project qylvmjncfblcsucfzdan
...
-- Index for quick per-email lookups and admin time-ordered listing
...
-- -----------------------------------------------------------------------
-- select count(*), max(created_at) from public.forensic_jobs;
